                ...
                toReview.map(item => (
                  <div key={item.id} className="bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl rounded-2xl p-5 shadow-sm border border-slate-100 dark:border-slate-800 hover:shadow-md transition-shadow flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between">
                    ...
                    <button 
                      ...
                      className="w-full sm:w-auto px-6 py-2.5 rounded-xl bg-gradient-to-r from-purple-600 to-blue-500 text-white font-medium hover:shadow-lg hover:shadow-purple-500/30 transition-all hover:scale-105 whitespace-nowrap"
                    >
                      Viết đánh giá
                    </button>
                  </div>
            ...
            >
              {reviews.length > 0 ? (
                ...
                <div className="bg-white/50 dark:bg-slate-900/50 backdrop-blur-xl rounded-2xl p-12 text-center border border-slate-100 dark:border-slate-800">
                  ...
                  <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-2">Chưa có đánh giá nào</h3>
                  <p className="text-slate-500 mb-6">Bạn chưa viết đánh giá nào cho các sản phẩm đã mua.</p>
                  <button onClick={() => setActiveTab('to-review')} className="inline-block px-8 py-3 rounded-xl bg-gradient-to-r from-purple-600 to-blue-500 text-white font-medium hover:shadow-lg hover:shadow-purple-500/30 transition-all hover:scale-105">
                    Đánh giá ngay
                  </button>
                </div>
              )}
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            >
              ...
              <div className="p-6 border-t border-slate-100 dark:border-slate-800 flex justify-end gap-3 bg-slate-50 dark:bg-slate-900/50">
                ...
                <button type="submit" form="review-form" className="px-6 py-2.5 rounded-xl bg-gradient-to-r from-purple-600 to-blue-500 text-white font-medium hover:shadow-lg hover:shadow-purple-500/30 transition-all hover:scale-105">
                  Hoàn thành
                </button>
              </div>
            </motion.div>
