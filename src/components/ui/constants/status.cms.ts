...
export const CMS_STATUS = {
  published: { label: 'Đã xuất bản', labelKey: 'status.cms.published', className: 'bg-green-100 text-green-600' },
  draft:     { label: 'Bản nháp', labelKey: 'status.cms.draft', className: 'bg-orange-100 text-orange-600' },
  hidden:    { label: 'Đã ẩn', labelKey: 'status.cms.hidden', className: 'bg-slate-100 text-slate-600' },
  ...
  approved:  { label: 'Đã duyệt', labelKey: 'status.cms.approved', className: 'bg-green-100 text-green-600' },
