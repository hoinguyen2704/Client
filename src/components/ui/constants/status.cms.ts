...
export const CMS_STATUS = {
  ...
  hidden:    { label: 'Hidden', labelKey: 'status.cms.hidden', className: 'bg-slate-100 text-body border-slate-200 dark:bg-slate-500/10 dark:border-slate-500/20' },
  ...
  user:      { label: 'User', labelKey: 'status.cms.user', className: 'bg-slate-100 text-body border-slate-200 dark:bg-slate-500/10 dark:border-slate-500/20' },
} as const;
