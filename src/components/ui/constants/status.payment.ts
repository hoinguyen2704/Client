...
export const PAYMENT_STATUS = {
  ...
  REFUNDED:  { label: 'Refunded', labelKey: 'status.payment.refunded', className: 'bg-slate-100 text-slate-700 border-slate-200 dark:bg-slate-500/10 dark:text-slate-300 dark:border-slate-500/20' },
} as const;
