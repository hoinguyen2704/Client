...
export const GENERIC_STATUS = {
  ...
  inactive:    { label: 'Suspended', labelKey: 'status.generic.inactive', className: 'bg-slate-100 text-slate-700 border-slate-200 dark:bg-slate-500/10 dark:text-slate-300 dark:border-slate-500/20' },
  expired:     { label: 'Expired', labelKey: 'status.generic.expired', className: 'bg-slate-100 text-slate-600 border-slate-200 dark:bg-slate-500/10 dark:text-slate-300 dark:border-slate-500/20' },
  ...
  closed:      { label: 'Closed', labelKey: 'status.generic.closed', className: 'bg-slate-100 text-slate-700 border-slate-200 dark:bg-slate-500/10 dark:text-slate-300 dark:border-slate-500/20' },
  ...
  INACTIVE:  { label: 'Hidden', labelKey: 'status.cms.hidden', className: 'bg-slate-100 text-slate-700 border-slate-200 dark:bg-slate-500/10 dark:text-slate-300 dark:border-slate-500/20' },
  ...
  CLOSED:      { label: 'Closed', labelKey: 'status.ticket.closed', className: 'bg-slate-100 text-slate-700 border-slate-200 dark:bg-slate-500/10 dark:border-slate-500/20 dark:text-slate-300' },
} as const;
