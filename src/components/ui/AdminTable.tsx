...
export function AdminTableHeadRow({
  ...
  return (
    <tr className={cn(ADMIN_TABLE_HEAD_ROW_CLASS, className)} {...props} />
  );
}
...
export function AdminTableBodyRow({
  ...
  return (
    <tr className={cn(ADMIN_TABLE_BODY_ROW_CLASS, className)} {...props} />
  );
}
...
export function AdminTableHeadCell({
  ...
  return (
    <th className={cn(ADMIN_TABLE_HEAD_CELL_CLASS, className)} {...props} />
  );
}
