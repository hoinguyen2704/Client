...
import type { ChatbotMessage, ChatbotResponse } from '@/apis/services/chatbotService';
  ...
  const handleSend = async () => {
    ...
    try {
      ...
      const errorMessage: Message = {
        id: (Date.now() + 1).toString(),
        role: 'model',
        text: 'Xin lỗi, đã có lỗi kết nối đến hệ thống. Vui lòng thử lại sau hoặc liên hệ hotline **1900-xxxx** để được hỗ trợ.',
      };
          ...
          >
            ...
            <div className="h-16 bg-gradient-to-r from-purple-600 to-blue-500 text-white flex items-center justify-between px-4 shrink-0">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="font-bold">Hozitech AI</h3>
                  <p className="text-xs text-white/80">Trợ lý tư vấn sản phẩm 24/7</p>
                </div>
              </div>
            ...
            <div className="p-4 bg-white dark:bg-slate-900 border-t border-slate-200 dark:border-slate-800 shrink-0">
              ...
              <p className="text-[10px] text-slate-400 dark:text-slate-600 mt-1.5 text-center">
                Powered by Hozitech Knowledge Base + AI
              </p>
            </div>
          </motion.div>
        )}
