  ...
  return (
    <div className="w-full px-3 sm:px-4 md:px-8 lg:px-12 py-10 sm:py-20">
      ...
      >
        {isSuccess ? (
          <>
            <div className="w-20 h-20 sm:w-24 sm:h-24 rounded-full bg-green-100 dark:bg-green-900/30 flex items-center justify-center mx-auto mb-4 sm:mb-6">
            ...
            <Link to="/" className="block w-full py-3.5 sm:py-4 rounded-xl bg-slate-100 dark:bg-slate-800 text-slate-900 dark:text-white font-bold hover:bg-slate-200 dark:hover:bg-slate-700 transition-all">
              Tiếp tục mua sắm
            </Link>
          </>
        ) : (
          <>
            ...
            <button 
              onClick={onRetry}
              className="block w-full py-3.5 sm:py-4 rounded-xl bg-gradient-to-r from-red-500 to-pink-500 text-white font-bold hover:shadow-lg hover:shadow-red-500/30 transition-all mb-3 sm:mb-4"
            >
              Thử lại
            </button>
            <Link to="/cart" className="block w-full py-3.5 sm:py-4 rounded-xl bg-slate-100 dark:bg-slate-800 text-slate-900 dark:text-white font-bold hover:bg-slate-200 dark:hover:bg-slate-700 transition-all">
              Quay lại giỏ hàng
            </Link>
          </>
        )}
