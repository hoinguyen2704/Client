          ...
          <div className="lg:col-span-8 space-y-3 sm:space-y-6">
            <div className="flex items-center justify-between p-3 sm:p-4 bg-white dark:bg-slate-900 rounded-2xl border border-slate-100 dark:border-slate-800">
              <label className="flex items-center gap-3 cursor-pointer">
                ...
                <span className="font-medium text-md">{t('cart.selectAll', { count: items.length })}</span>
              </label>
              <Button onClick={handleClearCart} variant="ghost" size="lg" icon={<FiTrash2 />} className="text-red-500 shrink-0">{t('cart.clearAction')}</Button>
            </div>
