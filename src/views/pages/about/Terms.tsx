    ...
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <div className="prose prose-blue max-w-none dark:prose-invert">
        <p className="text-gray-600 dark:text-gray-300 mb-6">
          Chào mừng bạn đến với Hozitech. Khi truy cập và sử dụng trang web của chúng tôi, bạn đồng ý tuân thủ các điều khoản và điều kiện dưới đây. Vui lòng đọc kỹ trước khi sử dụng dịch vụ.
        </p>

        <section className="mb-8">
          <h2 className="text-xl font-semibold mb-3">1. Chấp nhận điều khoản</h2>
          <p className="text-gray-600 dark:text-gray-300">
            Bằng việc truy cập, duyệt hoặc sử dụng trang web Hozitech, bạn xác nhận rằng bạn đã đọc, hiểu và đồng ý bị ràng buộc bởi các Điều khoản sử dụng này cũng như Chính sách bảo mật của chúng tôi. Nếu bạn không đồng ý với bất kỳ phần nào của các điều khoản này, vui lòng không sử dụng trang web.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-300">
            Mọi nội dung trên trang web này, bao gồm nhưng không giới hạn ở văn bản, hình ảnh, logo, video và mã nguồn, đều thuộc sở hữu của Hozitech hoặc các nhà cung cấp nội dung của chúng tôi và được bảo vệ bởi luật sở hữu trí tuệ.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-300">
            Hozitech có quyền sửa đổi, cập nhật các Điều khoản sử dụng này bất cứ lúc nào mà không cần báo trước. Việc bạn tiếp tục sử dụng trang web sau khi các thay đổi được đăng tải đồng nghĩa với việc bạn chấp nhận các điều khoản mới.
          </p>
        </section>
