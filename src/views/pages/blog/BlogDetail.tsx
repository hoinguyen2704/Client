...
const mockPost = {
  ...
  content: `
    ...
    <img src="https://picsum.photos/seed/iphone15-1/800/400" alt="iPhone 15 Pro Max Design" class="w-full rounded-2xl my-8 object-cover aspect-video" />
    ...
    <img src="https://picsum.photos/seed/iphone15-2/800/400" alt="iPhone 15 Pro Max USB-C" class="w-full rounded-2xl my-8 object-cover aspect-video" />
  ...
  `,
  image: 'https://picsum.photos/seed/iphone15/1200/600',
  date: '15/03/2026',
          ...
          <div className="flex gap-4 mb-8">
            ...
            <div className="flex-1">
              ...
              <div className="flex justify-end">
                <button className="px-8 py-3 bg-gradient-to-r from-purple-600 to-blue-500 text-white font-bold rounded-xl hover:shadow-lg hover:shadow-purple-500/30 transition-all">
                  Gửi bình luận
                </button>
              </div>
            </div>
