  ...
  return (
    <div className="flex flex-col items-center justify-center w-full min-h-[80vh] gap-12 py-8 bg-slate-50 dark:bg-slate-900 text-ink">
      <svg className="h-[40vh] aspect-video" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 500">
        ...
        <g id="freepik--Padlock--inject-3">
          <path
            ...
            style={{ fill: 'none', stroke: '#263238', strokeLinecap: 'round', strokeLinejoin: 'round', strokeWidth: 1.166 }}></path>
          <rect x="65.14" y="179.87" width="103.18" height="85.35"
            style={{ fill: 'none', stroke: '#263238', strokeLinecap: 'round', strokeLinejoin: 'round', strokeWidth: 1.166 }}></rect>
          <path
        ...
        <g id="freepik--Character--inject-3">
          <polygon
            ...
            style={{ fill: '#263238', stroke: '#263238', strokeLinecap: 'round', strokeLinejoin: 'round', strokeWidth: 1.166 }}></polygon>
          <path
            ...
            style={{ fill: '#4c4c4c', stroke: '#263238', strokeLinecap: 'round', strokeLinejoin: 'round', strokeWidth: 1.166 }}></path>
          <path d="M134.53,442.31v4.63h40.84s.19-2,.19-4.63Z"
            style={{ fill: '#263238', stroke: '#263238', strokeLinecap: 'round', strokeLinejoin: 'round', strokeWidth: 1.166 }}></path>
          <path
          ...
          <path
            ...
            style={{ fill: '#3B82F6', stroke: '#263238', strokeLinecap: 'round', strokeLinejoin: 'round', strokeWidth: 1.166 }}></path>
          <path
            ...
            style={{ fill: '#ccc', stroke: '#263238', strokeLinecap: 'round', strokeLinejoin: 'round', strokeWidth: 1.166 }}></path>
          <polygon
            points="170.38 193.6 164.07 195.51 174.01 261.86 233.09 261.86 242.08 195.89 234.05 192.83 204.41 186.33 170.38 193.6"
            style={{ fill: '#3B82F6', stroke: '#263238', strokeLinecap: 'round', strokeLinejoin: 'round', strokeWidth: 1.166 }}></polygon>
          ...
          <circle cx="225.35" cy="223.52" r="1.82"
            style={{ fill: '#4c4c4c', stroke: '#263238', strokeLinecap: 'round', strokeLinejoin: 'round', strokeWidth: 1.166 }}></circle>
          <polygon
          ...
          <polygon points="193.52 173.9 193.52 186.52 204.22 196.47 216.27 186.14 216.27 174.29 193.52 173.9"
            style={{ fill: '#ccc', stroke: '#263238', strokeLinecap: 'round', strokeLinejoin: 'round', strokeWidth: 1.166 }}></polygon>
          <path
          ...
          <line x1="203.36" y1="177.07" x2="207.35" y2="177.07"
            style={{ fill: '#ccc', stroke: '#263238', strokeLinecap: 'round', strokeLinejoin: 'round', strokeWidth: 1.166 }}></line>
          ...
          <rect x="173.13" y="261.25" width="60.63" height="9.54"
            style={{ fill: '#4c4c4c', stroke: '#263238', strokeLinecap: 'round', strokeLinejoin: 'round', strokeWidth: 1.166 }}></rect>
          ...
          <rect x="197.83" y="261.81" width="13.19" height="8.42"
            style={{ fill: '#fff', stroke: '#263238', strokeLinecap: 'round', strokeLinejoin: 'round', strokeWidth: 1.166 }}></rect>
          <path d="M156.28,241.32s-8.42-.56-11.51-5.9"
            style={{ fill: 'none', stroke: '#263238', strokeLinecap: 'round', strokeLinejoin: 'round', strokeWidth: 1.166 }}></path>
          <ellipse cx="249.9" cy="202.02" rx="13.9" ry="14.6"
            style={{ fill: '#3B82F6', stroke: '#263238', strokeLinecap: 'round', strokeLinejoin: 'round', strokeWidth: 1.166 }}></ellipse>
          <ellipse cx="249.9" cy="194.63" rx="10.88" ry="9.75"
            style={{ fill: '#3B82F6', stroke: '#263238', strokeLinecap: 'round', strokeLinejoin: 'round', strokeWidth: 1.166 }}></ellipse>
          <ellipse cx="249.9" cy="187.46" rx="10.88" ry="9.75"
            style={{ fill: '#ccc', stroke: '#263238', strokeLinecap: 'round', strokeLinejoin: 'round', strokeWidth: 1.166 }}></ellipse>
          <path
          ...
          <line x1="245.14" y1="154.64" x2="245.51" y2="171.6"
            style={{ fill: 'none', stroke: '#263238', strokeLinecap: 'round', strokeLinejoin: 'round', strokeWidth: 1.166 }}></line>
        ...
        <g id="freepik--security-barrier--inject-3">
          <polygon points="86.87 446.5 72.61 446.5 91.62 313.99 105.88 313.99 86.87 446.5"
            style={{ fill: '#263238', stroke: '#263238', strokeMiterlimit: 10, strokeWidth: 1.166 }}></polygon>
          <polygon points="115.39 446.5 129.64 446.5 110.63 313.99 96.38 313.99 115.39 446.5"
            style={{ fill: '#fff', stroke: '#263238', strokeMiterlimit: 10, strokeWidth: 1.166 }}></polygon>
          ...
          <rect x="55.73" y="293.21" width="271.93" height="26.36"
            style={{ fill: '#3B82F6', stroke: '#263238', strokeMiterlimit: 10, strokeWidth: 1.166 }}></rect>
          ...
          <line x1="332.8" y1="304.9" x2="287.8" y2="304.9"
            style={{ fill: 'none', stroke: '#263238', strokeMiterlimit: 10, strokeWidth: 1.166 }}></line>
          ...
          <rect x="331.37" y="440.72" width="77.14" height="5.79"
            style={{ fill: '#263238', stroke: '#263238', strokeLinecap: 'round', strokeLinejoin: 'round', strokeWidth: 1.166 }}></rect>
          ...
          <polygon points="356.98 372.1 382.91 372.1 380.42 358.6 359.46 358.6 356.98 372.1"
            style={{ fill: '#fff', stroke: '#263238', strokeLinecap: 'round', strokeLinejoin: 'round', strokeWidth: 1.166 }}></polygon>
          <line x1="387.81" y1="422.37" x2="389.09" y2="429.82"
            style={{ fill: '#3B82F6', stroke: '#263238', strokeLinecap: 'round', strokeLinejoin: 'round', strokeWidth: 1.166 }}></line>
      ...
      <div className="flex flex-col items-center gap-4">
        ...
        <Link to="/" className="mt-4 px-6 py-3 rounded-xl bg-blue-600 text-white font-medium hover:bg-blue-700 transition-colors">
          Go back to Home
        </Link>
      </div>
    </div>
