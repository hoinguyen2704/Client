...
import { Pagination, ActionButtons, PrimaryButton, ConfirmDialog, CustomSelect } from '@/components';
  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <PrimaryButton onClick={() => navigate('/admin/flash-sales/new')} icon={<FiPlus className="text-base" />} className="w-full sm:w-auto">
          Tạo Flash Sale
        </PrimaryButton>
      </div>
                  ...
                  <td className="p-3 sm:p-4">
                    <ActionButtons
                      actions={[
                        {
                          type: 'edit',
                          onClick: () => navigate(`/admin/flash-sales/${sale.id}/edit`)
                        },
                        {
                          type: 'delete',
